...
<style>
    .highlight-code {
        background-color: #ffff00 !important; color: black !important; padding: 10px;
        border-radius: 5px; font-weight: bold; font-family: monospace;
        border-left: 5px solid #ff4b4b; margin-bottom: 5px; display: block;
    }
    .standard-code {
        background-color: #1e1e1e !important; color: #d4d4d4 !important; padding: 10px;
        border-radius: 5px; font-family: monospace;
        margin-bottom: 5px; opacity: 0.8; display: block;
    }
    .theory-section {
        background-color: #262730; padding: 20px; border-radius: 10px;
        border-top: 3px solid #458588; margin-bottom: 20px;
    }
</style>
